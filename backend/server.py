...
# Load .env BEFORE importing routers so they can read API keys
ROOT_DIR = Path(__file__).parent
load_dotenv(ROOT_DIR / '.env')

from ai_router import router as ai_router_instance
from auth_router import router as auth_router_instance
...
# Register feature routers (existing)
app.include_router(ai_router_instance)
app.include_router(auth_router_instance)

# Register new routers (PDF compiler and enhanced ATS scorer)
