...
const Home = () => {
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0b]">
      <SEOHead
        title="CVCraft - AI-Powered Professional Resume Builder"
        description="Create professional, ATS-optimized resumes in minutes with AI-powered suggestions. Choose from 6 templates and download as PDF."
        path="/"
      />
      {/* Header */}
              ...
              <div className="bg-gradient-to-br from-[#0066ff]/10 to-[#0066ff]/5 rounded-3xl p-12 border border-[#0066ff]/20">
                <div className="space-y-8">
                  ...
                  <div>
                    ...
                    <div className="text-gray-400">Unlimited CVs</div>
                  </div>
                  <div>
